...
public class PainController : FighterBase
{
    [Header("--- PAIN SKILLS ---")]
    public PainRangedSkill rangedSkill;
    public PainUltimateSkill ultimateSkill;
    ...
    protected override void Awake()
    {
        ...
        if (rangedSkill == null)
        {
            rangedSkill = GetComponent<PainRangedSkill>();
            if (rangedSkill == null)
            {
                rangedSkill = gameObject.AddComponent<PainRangedSkill>();
            }
        }

        if (ultimateSkill == null)
        {
            ultimateSkill = GetComponent<PainUltimateSkill>();
            if (ultimateSkill == null)
            {
                ultimateSkill = gameObject.AddComponent<PainUltimateSkill>();
            }
        }
    ...
    private void LoadKeybindings()
    {
        ...
        if (System.IO.File.Exists(saveFilePath))
        {
            ...
            {
                Debug.LogWarning($"[PainController] Failed to parse settings.json: {ex.Message}");
            }
        }
    ...
    private IEnumerator ExecuteUltimateWithFlash()
    {
        ...
        if (flashSprite != null)
        {
            UltimateFlashEffect.Show(this, flashSprite, ultimateFlashSizeFactor, ultimateFlashOffset, new Color(0.9f, 0.4f, 0.1f), () =>
            {
                flashDone = true;
            });
    ...
    private Sprite LoadUltimateAvatar()
    {
        ...
        Sprite s = Resources.Load<Sprite>("Pain/avatar/avatar_pain");
        return s;
    }
    ...
    public Sprite LoadPainSprite(string spriteName)
    {
        ...
        string charDir = "Assets/_Project/Characters/Pain";
    ...
    public System.Collections.Generic.List<Sprite> LoadAllPainSprites(string filename)
    {
